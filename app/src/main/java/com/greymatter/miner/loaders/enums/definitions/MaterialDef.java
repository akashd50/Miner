...
public enum MaterialDef {
    ...
    DIALOG_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.DIALOG_OPTIONS, null),
    OK_BUTTON_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.OK_BUTTON, null),
    CANCEL_BUTTON_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.CANCEL_BUTTON, null),
    UPGRADE_BUTTON_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.UPGRADE_BUTTON, null),
    DIALOG_SIMPLE_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.DIALOG_SIMPLE, null),
    ...
    OIL_DRILL_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.OIL_DRILL_I, null),
    OIL_DEP_OUTER_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.OIL_OUTER_LAYER, null),
    OIL_DEP_INNER_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.OIL_INNER_OIL, null),
    PIPE_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.PIPE_I, null),

    MOVE_ICON_OFF_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.MOVE_ICON_OFF_I, null),
    MOVE_ICON_ON_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.MOVE_ICON_ON_I, null),
    MOVE_OVERLAY_MATERIAL(MaterialType.STATIC_TEXTURED_MATERIAL, Path.MOVE_OVERLAY, null),
