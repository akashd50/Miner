...
public enum DrawableDef {
    ...
    OK_BUTTON(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.OK_BUTTON_MATERIAL, ShaderDef.QUAD_SHADER),
    CANCEL_BUTTON(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.CANCEL_BUTTON_MATERIAL, ShaderDef.QUAD_SHADER),
    UPGRADE_BUTTON(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.UPGRADE_BUTTON_MATERIAL, ShaderDef.QUAD_SHADER),
    SIMPLE_DIALOG(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.DIALOG_SIMPLE_MATERIAL, ShaderDef.QUAD_SHADER),
    OBJECT_SIGNAL(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.SIGNAL_MATERIAL, ShaderDef.LIGHTING_SHADER),

    BUILDING_MOVE_TARGET(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.MOVE_OVERLAY_MATERIAL, ShaderDef.QUAD_SHADER),
    ...
    PIPES_INSTANCE_GROUP(DrawableType.INSTANCE_GROUP, null, MaterialDef.PIPE_MATERIAL, ShaderDef.INSTANCE_SHADER),
    JOINTS_INSTANCE_GROUP(DrawableType.INSTANCE_GROUP, null, MaterialDef.ADD_MARKER_MATERIAL, ShaderDef.INSTANCE_SHADER),

    OIL_RESOURCE_OUTER_INSTANCE_GROUP(DrawableType.INSTANCE_GROUP, null, MaterialDef.OIL_DEP_OUTER_MATERIAL, ShaderDef.INSTANCE_SHADER),
    OIL_RESOURCE_INNER_INSTANCE_GROUP(DrawableType.INSTANCE_GROUP, null, MaterialDef.PIPE_MATERIAL, ShaderDef.INSTANCE_SHADER),
