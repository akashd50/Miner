...
public enum DrawableDef {
    ...
    NOT_BUTTON_I(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.BUTTON_MATERIAL_I, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    NOT_BUTTON_II(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.BUTTON_MATERIAL_I, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    NOT_BUTTON_III(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.BUTTON_MATERIAL_I, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
