...
public enum DrawableDef {
    ATMOSPHERE(DrawableType.OBJ, ShapeDef.CIRCLE_SIMPLE, MaterialDef.ATMOSPHERE_MATERIAL, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    ...
    MAIN_BASE(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.MAIN_BASE_MATERIAL, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    ...
    PIE_GRADIENT_I(DrawableType.RADIANT_GRADIENT, ShapeDef.PIE_45, MaterialDef.GRADIENT_COLOR_MATERIAL, ShaderDef.CIRCLE_GRADIENT_SHADER),

    DIALOG_BUTTON_I(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.BUTTON_MATERIAL_I, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    DIALOG_BUTTON_II(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.BUTTON_MATERIAL_I, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    DIALOG_BUTTON_III(DrawableType.OBJ, ShapeDef.UV_MAPPED_BOX, MaterialDef.BUTTON_MATERIAL_I, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER),
    OBJECT_NOTIFICATION(DrawableType.QUAD, ShapeDef.SIMPLE_QUAD, MaterialDef.DIALOG_MATERIAL, ShaderDef.QUAD_SHADER),

    COAL_BLOCK_I(DrawableType.OBJ, ShapeDef.COLLISION_BOX, MaterialDef.GROUND_MATERIAL, ShaderDef.THREE_D_OBJECT_W_LIGHTING_SHADER);
